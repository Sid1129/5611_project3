...
class Camera
{
  ...
  {
    if ( key == 'w' || key == 'W' ) positiveMovement.z = 10;
    if ( key == 's' || key == 'S' ) negativeMovement.z = -10;
    if ( key == 'a' || key == 'A' ) negativeMovement.x = -10;
    if ( key == 'd' || key == 'D' ) positiveMovement.x = 10;
    if ( key == 'q' || key == 'Q' ) positiveMovement.y = 10;
    if ( key == 'e' || key == 'E' ) negativeMovement.y = -10;
